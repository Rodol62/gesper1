...
class PropostaAssunzioneForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            'tredicesima',
            'quattordicesima',
            'tredicesima_rateo_mensile_in_imponibile',
            'quattordicesima_rateo_mensile_in_imponibile',
        ...
        widgets = {
            ...
            'superminimo_mensile': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01'}),
