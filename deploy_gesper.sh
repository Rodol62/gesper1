...
scp -r accounts anagrafiche costo_lavoro documenti log_attivita notifiche notifiche_email partitario_netti presenze rapporto_di_lavoro report richieste ruoli static storico templates workflow manage.py settings.py urls.py wsgi.py asgi.py "$REMOTE:$REMOTE_DIR/"
