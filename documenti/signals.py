...
def elimina_estrazioni_motore_v4_collegate_a_busta(sender, instance: Documento, **kwargs):
    ...
    La catena referenziale verso il partitario netti è completata da
    ``partitario_netti.signals.rimuovi_movimenti_partitario_dare_collegati_a_cedolino_v4``,
    invocato in ``pre_delete`` su ogni cedolino v4 rimosso.
    """
