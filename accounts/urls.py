...
from .views_impostazioni import impostazioni_sistema, geocode_impostazioni
...
from .views_consulente import (
    ...
    consulente_bonifici_dipendenti,
    consulente_partitario_dipendente,
...
urlpatterns = [
    ...
    path('consulente/bonifici-dipendenti/', consulente_bonifici_dipendenti, name='consulente_bonifici_dipendenti'),
    path(
        'consulente/partitario-paghe/dipendente/<int:dipendente_id>/',
        consulente_partitario_dipendente,
        name='consulente_partitario_dipendente',
    ),
